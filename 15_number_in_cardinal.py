...
def number_in_cardinal(number, nindex=0):
    ...
    for divisor, suffix in DIVISORS:
        ...
        result += number_in_cardinal(value, -1 if (divisor == value) else 0)
...
if __name__ == '__main__':
    ...
    test(number_in_cardinal, 100000, "cem mil")
    ...
    test(number_in_cardinal, 100000000, "cem milhões")
    ...
    test(number_in_cardinal, 100000000000, "cem bilhões")
    test(number_in_cardinal, 1000000000000, "um trilhão")
    test(number_in_cardinal, 2000000000000, "dois trilhões")
    test(number_in_cardinal, 100000000000000, "cem trilhões")
    test(number_in_cardinal, 101000000000000, "cento e um trilhões")
    test(number_in_cardinal, 110000000000000, "cento e dez trilhões")
    test(number_in_cardinal, 111000000000000, "cento e onze trilhões")
